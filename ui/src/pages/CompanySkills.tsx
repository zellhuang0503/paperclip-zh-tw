    ...
    <div className="border-b border-border px-4 py-4">
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          >
            {isPending ? t("pages.companySkills.creatingSkill") : t("pages.companySkills.createSkill")}
          </Button>
        </div>
      </div>
    </div>
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          {detail.editable ? (
            ...
            >
              ...
              {editMode ? t("pages.companySkills.stopEditing") : t("common.edit")}
            </button>
          ) : (
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {updateStatus?.supported && updateStatus.hasUpdate && (
                  ...
                  >
                    ...
                    {t("pages.companySkills.installUpdate", { pin: latestPin ?? "" })}
                  </Button>
                )}
            ...
            {editMode && file?.editable && (
              <>
                ...
                <Button size="sm" onClick={onSave} disabled={savePending}>
                  ...
                  {savePending ? t("pages.companySkills.savingFile") : t("pages.companySkills.saveFile")}
                </Button>
              </>
            )}
          </div>
...
export function CompanySkills() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      ...(routeSkillId ? [{ label: t("pages.companySkills.title") }] : []),
    ]);
  ...
  const importSkill = useMutation({
    ...
    onSuccess: async (result) => {
      ...
      pushToast({
        ...
        body: t("pages.companySkills.skillsImportedBody", { count: result.imported.length }),
      });
    ...
    onError: (error) => {
      pushToast({
        tone: "error",
        title: t("pages.companySkills.importFailed"),
        body: error instanceof Error ? error.message : t("pages.companySkills.importFailedBody"),
      });
    },
  });
  ...
  const createSkill = useMutation({
    ...
    onError: (error) => {
      pushToast({
        ...
        body: error instanceof Error ? error.message : t("pages.companySkills.skillCreationFailedBody"),
      });
    },
  });
  ...
  const scanProjects = useMutation({
    ...
    onSuccess: async (result) => {
      setScanStatusMessage(t("pages.companySkills.refreshingList"));
      await queryClient.invalidateQueries({ queryKey: queryKeys.companySkills.list(selectedCompanyId!) });
      const summary = formatProjectScanSummary(result);
      setScanStatusMessage(summary);
      pushToast({
        tone: "success",
        title: t("pages.companySkills.scanComplete"),
        body: summary,
      });
      if (result.conflicts[0]) {
        pushToast({
          tone: "warn",
          title: t("pages.companySkills.scanConflicts"),
    ...
    onError: (error) => {
      ...
      pushToast({
        tone: "error",
        title: t("pages.companySkills.scanFailed"),
        body: error instanceof Error ? error.message : t("pages.companySkills.scanFailedBody"),
      });
    },
  });
  ...
  const saveFile = useMutation({
    ...
    onError: (error) => {
      pushToast({
        ...
        body: error instanceof Error ? error.message : t("pages.companySkills.saveFailedBody"),
      });
    },
  });
  ...
  const installUpdate = useMutation({
    ...
    onSuccess: async (skill) => {
      ...
      pushToast({
        ...
        body: skill.sourceRef ? t("pages.companySkills.skillUpdatedBody", { pin: shortRef(skill.sourceRef) }) : skill.name,
      });
    },
    onError: (error) => {
      pushToast({
        ...
        body: error instanceof Error ? error.message : t("pages.companySkills.updateFailedBody"),
      });
    },
  });
